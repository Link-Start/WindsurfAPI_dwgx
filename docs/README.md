...
flowchart TD
    ...
    Q -->|"what changed"| REL["releases/<br/>182 notes, v2.0.6 → v3.9.31"]
...
| # | File | Why |
|---|---|---|
| 1 | **[HANDOFF-2026-08-20.md](HANDOFF-2026-08-20.md)** | Current state (v3.9.31), what to expose, what is blocked on someone else. Read §1 first (three operational traps), then §2 (public vs never-git). Product tag is v3.9.31; OTA follows the latest annotated tag, not later untagged SHAs. |
